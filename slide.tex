...
\author{答辩者}
\title{TJU Beamer Theme}
\subtitle{毕业答辩}
\institute{天津大学未来技术学院}
\date{2026年x月x日}
\usepackage{Peiyang}
...
\begin{frame}
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/Peiyang_University_Logo.eps}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}
    \begin{itemize}
        ...
        \item 但是最初的 \href{http://far.tooold.cn/post/latex/beamertsinghua}{\color{purple}{link}} \cite{orgin}已经失效了
